...
import { getRejectionReason, updateRejectionReason } from "../services/Apis";
import toast from "react-hot-toast";

const SubsRejectionReasonEdit = () => {
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    try {
      let response = await updateRejectionReason(form.sno, form);
...
export default SubsRejectionReasonEdit;
